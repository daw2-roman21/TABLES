...
//CREO LA VARIABLE FECHA QUE VAYA CAMBIANDO
...
function medias($review_movie_id){
    global $db;
...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php?movie_id=$idPeli&date=$fecha">Date</a></th>
